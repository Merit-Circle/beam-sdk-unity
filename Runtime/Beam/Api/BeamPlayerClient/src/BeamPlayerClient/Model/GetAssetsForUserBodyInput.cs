...
namespace BeamPlayerClient.Model
{
    ...
    public partial class GetAssetsForUserBodyInput
    {
        ...
        [UnityEngine.Scripting.Preserve]
        public GetAssetsForUserBodyInput(SortDirectionEnum? sortDirection = SortDirectionEnum.Asc, SortByEnum? sortBy = SortByEnum.AcquiredAt, string contract = default(string), bool? includeAttributes = false, string continuation = default(string), long chainId = 13337, decimal limit = 20M)
        {
