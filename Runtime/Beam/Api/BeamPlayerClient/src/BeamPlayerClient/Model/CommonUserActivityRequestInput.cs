...
namespace BeamPlayerClient.Model
{
    ...
    public partial class CommonUserActivityRequestInput
    {
        ...
        [UnityEngine.Scripting.Preserve]
        public CommonUserActivityRequestInput(decimal limit = 20M, List<TypesEnum> types = default(List<TypesEnum>), long chainId = 13337, string continuation = default(string))
        {
            this.Limit = limit;
            this.Types = types;
