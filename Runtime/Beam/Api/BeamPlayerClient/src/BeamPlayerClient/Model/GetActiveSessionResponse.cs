...
namespace BeamPlayerClient.Model
{
    ...
    public partial class GetActiveSessionResponse
    {
        ...
        public GetActiveSessionResponse(string id = default(string), bool isActive = default(bool), DateTime startTime = default(DateTime), DateTime endTime = default(DateTime), string sessionAddress = default(string))
        {
