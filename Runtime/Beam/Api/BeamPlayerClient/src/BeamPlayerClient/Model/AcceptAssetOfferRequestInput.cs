...
namespace BeamPlayerClient.Model
{
    ...
    public partial class AcceptAssetOfferRequestInput
    {
        ...
        [UnityEngine.Scripting.Preserve]
        public AcceptAssetOfferRequestInput(decimal quantity = default(decimal), bool optimistic = false, bool sponsor = true, string policyId = default(string), long chainId = 13337, OperationProcessingEnum? operationProcessing = OperationProcessingEnum.Execute, string operationId = default(string))
        {
