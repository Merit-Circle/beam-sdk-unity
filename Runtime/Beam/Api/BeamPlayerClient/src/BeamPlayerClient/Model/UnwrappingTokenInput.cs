...
namespace BeamPlayerClient.Model
{
    ...
    public partial class UnwrappingTokenInput
    {
        ...
        [UnityEngine.Scripting.Preserve]
        public UnwrappingTokenInput(string amount = default(string), bool optimistic = false, bool sponsor = true, string policyId = default(string), long chainId = 13337, OperationProcessingEnum? operationProcessing = OperationProcessingEnum.Execute, string operationId = default(string))
        {
