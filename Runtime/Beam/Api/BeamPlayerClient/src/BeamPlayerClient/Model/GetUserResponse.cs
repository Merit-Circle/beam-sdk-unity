...
namespace BeamPlayerClient.Model
{
    ...
    public partial class GetUserResponse
    {
        ...
        public GetUserResponse(string externalEntityId = default(string), string userId = default(string), string gameId = default(string), List<GetAllUsersResponseDataInnerWalletsInner> wallets = default(List<GetAllUsersResponseDataInnerWalletsInner>))
        {
            ...
            {
                throw new ArgumentNullException("externalEntityId is a required property for GetUserResponse and cannot be null");
            }
            this.ExternalEntityId = externalEntityId;
            // to ensure "userId" is required (not null)
            if (userId == null)
            {
                throw new ArgumentNullException("userId is a required property for GetUserResponse and cannot be null");
            }
            this.UserId = userId;
            // to ensure "gameId" is required (not null)
            if (gameId == null)
            {
                throw new ArgumentNullException("gameId is a required property for GetUserResponse and cannot be null");
            }
            this.GameId = gameId;
