...
namespace BeamPlayerClient.Model
{
    ...
    public partial class RefreshTokenRequestBody
    {
        ...
        public RefreshTokenRequestBody(string assetAddress = default(string), string tokenId = default(string), decimal chainId = 13337M)
        {
            ...
            {
                throw new ArgumentNullException("assetAddress is a required property for RefreshTokenRequestBody and cannot be null");
            }
            this.AssetAddress = assetAddress;
            // to ensure "tokenId" is required (not null)
            if (tokenId == null)
            {
                throw new ArgumentNullException("tokenId is a required property for RefreshTokenRequestBody and cannot be null");
            }
