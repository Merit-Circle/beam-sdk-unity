...
{
    /// <summary>
    /// GetAssetsForUserResponseDataInner
    /// </summary>
    [DataContract(Name = "GetAssetsForUserResponse_data_inner")]
    [UnityEngine.Scripting.Preserve]
    public partial class GetAssetsForUserResponseDataInner
    {
        /// <summary>
        /// Defines Rarity
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAssetsForUserResponseDataInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        [UnityEngine.Scripting.Preserve]
        protected GetAssetsForUserResponseDataInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAssetsForUserResponseDataInner" /> class.
        /// </summary>
        ...
        public GetAssetsForUserResponseDataInner(string name = default(string), string imageUrl = default(string), string assetType = default(string), string assetAddress = default(string), string assetId = default(string), decimal supply = default(decimal), RarityEnum? rarity = default(RarityEnum?), decimal? rarityScore = default(decimal?), List<GetAssetsForUserResponseDataInnerAttributesInner> attributes = default(List<GetAssetsForUserResponseDataInnerAttributesInner>), long chainId = 13337, decimal ownedQuantity = default(decimal))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for GetAssetsForUserResponseDataInner and cannot be null");
            }
            this.Name = name;
            // to ensure "imageUrl" is required (not null)
            if (imageUrl == null)
            {
                throw new ArgumentNullException("imageUrl is a required property for GetAssetsForUserResponseDataInner and cannot be null");
            }
            this.ImageUrl = imageUrl;
            // to ensure "assetType" is required (not null)
            if (assetType == null)
            {
                throw new ArgumentNullException("assetType is a required property for GetAssetsForUserResponseDataInner and cannot be null");
            }
            this.AssetType = assetType;
            // to ensure "assetAddress" is required (not null)
            if (assetAddress == null)
            {
                throw new ArgumentNullException("assetAddress is a required property for GetAssetsForUserResponseDataInner and cannot be null");
            }
            this.AssetAddress = assetAddress;
            // to ensure "assetId" is required (not null)
            if (assetId == null)
            {
                throw new ArgumentNullException("assetId is a required property for GetAssetsForUserResponseDataInner and cannot be null");
            }
        ...
        /// </summary>
        [DataMember(Name = "ownedQuantity", IsRequired = true, EmitDefaultValue = true)]
        [UnityEngine.Scripting.Preserve]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetAssetsForUserResponseDataInner {\n");
